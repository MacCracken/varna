...
- **License**: GPL-3.0
- **Toolchain**: Cyrius, pinned in `cyrius.cyml` (`cyrius = "6.5.36"`)
- **Version**: SemVer; canonical source is `VERSION` (read by `cyrius.cyml` via `${file:VERSION}`). Current target: **2.4.0**
